...
!function () {
    ...
    }), l = Object.prototype.hasOwnProperty, y = Object.assign || function (e) {
    ...
    var t = Object.freeze({
        ...
        documentReady: e
    }), A = decodeURIComponent, T = encodeURIComponent;
    ...
    function R(e, t) {
        void 0 === t && (t = []);
        var n, r = [];
        for (n in e) -1 < t.indexOf(n) || r.push(e[n] ? (T(n) + "=" + T(e[n])).toLowerCase() : T(n));
    ...
    I.prototype.getBasePath = function () {
        ...
        var n, r, i = this.config, o = this.getBasePath(), a = "string" == typeof i.ext ? i.ext : ".md";
        ...
        }(e, i.alias) : e, n = e, r = a, e = (e = new RegExp("\\.(" + r.replace(/^\./, "") + "|html)$", "g").test(n) ? n : /\/$/g.test(n) ? n + "README" + r : "" + n + r) === "/README" + a && i.homepage || e, e = O(e) ? e : N(o, e), t && (e = e.replace(new RegExp("^" + o), "")), e
        ...
        var r = n && "#" === e[0], i = this.parse(M(e));
        if (i.query = y({}, i.query, t), e = (e = i.path + R(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r && (e = (0 < (r = n.indexOf("?")) ? n.substring(0, r) : n) + e), this.config.relativePath && 0 !== e.indexOf("/")) {
    ...
    var H = function (r) {
        ...
        return r && (e.__proto__ = r), ((e.prototype = Object.create(r && r.prototype)).constructor = e).prototype.getBasePath = function () {
            ...
            0 <= n && (e = e.slice(n + 1));
            n = e.indexOf("?");
            return 0 <= n && (t = e.slice(n + 1), e = e.slice(0, n)), {path: e, file: this.getFile(e, !0), query: E(t)}
        ...
        return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath = function () {
            ...
            var r = this;
            void 0 === n && (n = u), x("click", function (e) {
                var t = "A" === e.target.tagName ? e.target : e.target.parentNode;
                t && "A" === t.tagName && !/_blank/.test(t.target) && (e.preventDefault(), t = t.href, -1 !== r.config.crossOriginLinks.indexOf(t) ? window.open(t, "_self") : window.history.pushState({key: t}, "", t), n({
                    event: e,
                    source: "navigate"
                }))
            ...
            var r = N(location.origin), n = e.indexOf(r);
            return -1 < n && (e = e.slice(n + r.length)), {path: e, file: this.getFile(e), query: E(t)}
        }, e
    }(I), U = {};
    var B = /([^{]*?)\w(?=\})/g, Z = {
    ...
    var G, W = Object.hasOwnProperty, V = Object.setPrototypeOf, Y = Object.isFrozen, X = Object.getPrototypeOf,
        K = Object.getOwnPropertyDescriptor, Fe = Object.freeze, Q = Object.seal, J = Object.create,
        ee = "undefined" != typeof Reflect && Reflect, te = (te = ee.apply) || function (e, t, n) {
            return e.apply(t, n)
        }, Fe = Fe || function (e) {
            return e
        }, Q = Q || function (e) {
            return e
        }, ne = (ne = ee.construct) || function (e, t) {
        ...
        }, Ce = re(Array.prototype.forEach), Le = re(Array.prototype.pop), ze = re(Array.prototype.push),
        Ne = re(String.prototype.toLowerCase), Me = re(String.prototype.match), De = re(String.prototype.replace),
        Pe = re(String.prototype.indexOf), Ie = re(String.prototype.trim), je = re(RegExp.prototype.test),
        He = (G = TypeError, function () {
    ...
    function qe(e, t) {
        ...
        for (var n = t.length; n--;) {
            var r, i = t[n];
            "string" != typeof i || (r = Ne(i)) !== i && (Y(t) || (t[n] = r), i = r), e[i] = !0
        }
        return e
    }

    function Ue(e) {
        var t = J(null), n = void 0;
    ...
    var Ze = Fe(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        Ge = Fe(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]),
        We = Fe(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]),
        Ve = Fe(["animate", "color-profile", "cursor", "discard", "fedropshadow", "feimage", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"]),
        Ye = Fe(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover"]),
        Xe = Fe(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]),
        Ke = Fe(["#text"]),
        ...
        et = Fe(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]),
        tt = Fe(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
        nt = Q(/\{\{[\s\S]*|[\s\S]*\}\}/gm), rt = Q(/<%[\s\S]*|[\s\S]*%>/gm), it = Q(/^data-[\-\w.\u00B7-\uFFFF]/),
        ot = Q(/^aria-[\-\w]+$/),
        at = Q(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        st = Q(/^(?:\w+script|data):/i), lt = Q(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
    ...
    var pt = function () {
        ...
        if ("object" !== (void 0 === e ? "undefined" : ct(e)) || "function" != typeof e.createPolicy) return null;
    ...
    var ie, oe, ae = function t(e) {
        function c(e) {
            return t(e)
        }

        var s = 0 < arguments.length && void 0 !== e ? e : pt();
        if (c.version = "2.3.1", c.removed = [], !s || !s.document || 9 !== s.document.nodeType) return c.isSupported = !1, c;
        var l = s.document, o = s.document, u = s.DocumentFragment, n = s.HTMLTemplateElement, p = s.Node,
            a = s.Element, r = s.NodeFilter, i = s.NamedNodeMap,
            h = void 0 === i ? s.NamedNodeMap || s.MozNamedAttrMap : i, d = s.Text, f = s.Comment, g = s.DOMParser,
            e = s.trustedTypes, i = a.prototype, m = Be(i, "cloneNode"), v = Be(i, "nextSibling"),
            y = Be(i, "childNodes"), b = Be(i, "parentNode");
        "function" != typeof n || (n = o.createElement("template")).content && n.content.ownerDocument && (o = n.content.ownerDocument);
        var k = ht(e, l), w = k && ee ? k.createHTML("") : "", x = o.implementation, _ = o.createNodeIterator,
            S = o.createDocumentFragment, A = o.getElementsByTagName, T = l.importNode, E = {};
        try {
            E = Ue(o).documentMode ? o.documentMode : {}
        } catch (e) {
        }
        var R = {};
        c.isSupported = "function" == typeof b && x && void 0 !== x.createHTMLDocument && 9 !== E;

        function O(e) {
            ge && ge === e || (e && "object" === (void 0 === e ? "undefined" : ct(e)) || (e = {}), e = Ue(e), P = "ALLOWED_TAGS" in e ? qe({}, e.ALLOWED_TAGS) : I, j = "ALLOWED_ATTR" in e ? qe({}, e.ALLOWED_ATTR) : H, le = "ADD_URI_SAFE_ATTR" in e ? qe(Ue(ce), e.ADD_URI_SAFE_ATTR) : ce, ae = "ADD_DATA_URI_TAGS" in e ? qe(Ue(se), e.ADD_DATA_URI_TAGS) : se, ie = "FORBID_CONTENTS" in e ? qe({}, e.FORBID_CONTENTS) : oe, q = "FORBID_TAGS" in e ? qe({}, e.FORBID_TAGS) : {}, U = "FORBID_ATTR" in e ? qe({}, e.FORBID_ATTR) : {}, $ = "USE_PROFILES" in e && e.USE_PROFILES, B = !1 !== e.ALLOW_ARIA_ATTR, Z = !1 !== e.ALLOW_DATA_ATTR, G = e.ALLOW_UNKNOWN_PROTOCOLS || !1, W = e.SAFE_FOR_TEMPLATES || !1, V = e.WHOLE_DOCUMENT || !1, K = e.RETURN_DOM || !1, Q = e.RETURN_DOM_FRAGMENT || !1, J = !1 !== e.RETURN_DOM_IMPORT, ee = e.RETURN_TRUSTED_TYPE || !1, X = e.FORCE_BODY || !1, te = !1 !== e.SANITIZE_DOM, ne = !1 !== e.KEEP_CONTENT, re = e.IN_PLACE || !1, D = e.ALLOWED_URI_REGEXP || D, de = e.NAMESPACE || he, W && (Z = !1), Q && (K = !0), $ && (P = qe({}, [].concat(ut(Ke))), j = [], !0 === $.html && (qe(P, Ze), qe(j, Qe)), !0 === $.svg && (qe(P, Ge), qe(j, Je), qe(j, tt)), !0 === $.svgFilters && (qe(P, We), qe(j, Je), qe(j, tt)), !0 === $.mathMl && (qe(P, Ye), qe(j, et), qe(j, tt))), e.ADD_TAGS && (P === I && (P = Ue(P)), qe(P, e.ADD_TAGS)), e.ADD_ATTR && (j === H && (j = Ue(j)), qe(j, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && qe(le, e.ADD_URI_SAFE_ATTR), e.FORBID_CONTENTS && (ie === oe && (ie = Ue(ie)), qe(ie, e.FORBID_CONTENTS)), ne && (P["#text"] = !0), V && qe(P, ["html", "head", "body"]), P.table && (qe(P, ["tbody"]), delete q.tbody), Fe && Fe(e), ge = e)
        }

        var $, F = nt, C = rt, L = it, z = ot, N = st, M = lt, D = at, P = null,
            I = qe({}, [].concat(ut(Ze), ut(Ge), ut(We), ut(Ye), ut(Ke))), j = null,
            H = qe({}, [].concat(ut(Qe), ut(Je), ut(et), ut(tt))), q = null, U = null, B = !0, Z = !0, G = !1, W = !1,
            V = !1, Y = !1, X = !1, K = !1, Q = !1, J = !0, ee = !1, te = !0, ne = !0, re = !1, ie = null,
            ...
            ae = null, se = qe({}, ["audio", "video", "img", "source", "image", "track"]), le = null,
            ce = qe({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
            ue = "http://www.w3.org/1998/Math/MathML", pe = "http://www.w3.org/2000/svg",
            he = "http://www.w3.org/1999/xhtml", de = he, fe = !1, ge = null, me = o.createElement("form"),
            ve = qe({}, ["mi", "mo", "mn", "ms", "mtext"]),
            ye = qe({}, ["foreignobject", "desc", "title", "annotation-xml"]), be = qe({}, Ge);
        qe(be, We), qe(be, Ve);
        var ke = qe({}, Ye);
        qe(ke, Xe);
        ...
        function xe(e, t) {
            ...
            if (t.removeAttribute(e), "is" === e && !j[e]) if (K || Q) try {
                we(t)
            } catch (e) {
            } else try {
                t.setAttribute(e, "")
        ...
        function _e(e) {
            ...
            return e && n && i.insertBefore(o.createTextNode(n), i.childNodes[0] || null), de === he ? A.call(t, V ? "html" : "body")[0] : V ? t.documentElement : i
        }
        ...
        function Ae(e) {
            return "object" === (void 0 === p ? "undefined" : ct(p)) ? e instanceof p : e && "object" === (void 0 === e ? "undefined" : ct(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
        }

        function Te(e, t, n) {
            R[e] && Ce(R[e], function (e) {
                e.call(c, t, n, ge)
            })
        }
        ...
        function Ee(e) {
            var t;
            if (Te("beforeSanitizeElements", e, null), !((n = e) instanceof d || n instanceof f || "string" == typeof n.nodeName && "string" == typeof n.textContent && "function" == typeof n.removeChild && n.attributes instanceof h && "function" == typeof n.removeAttribute && "function" == typeof n.setAttribute && "string" == typeof n.namespaceURI && "function" == typeof n.insertBefore)) return we(e), 1;
            if (Me(e.nodeName, /[\u0080-\uFFFF]/)) return we(e), 1;
            var n = Ne(e.nodeName);
            if (Te("uponSanitizeElement", e, {
                tagName: n,
                allowedTags: P
            }), !Ae(e.firstElementChild) && (!Ae(e.content) || !Ae(e.content.firstElementChild)) && je(/<[/\w]/g, e.innerHTML) && je(/<[/\w]/g, e.textContent)) return we(e), 1;
            if ("select" === n && je(/<template/i, e.innerHTML)) return we(e), 1;
            if (P[n] && !q[n]) return e instanceof a && !function (e) {
                var t = b(e);
                t && t.tagName || (t = {namespaceURI: he, tagName: "template"});
                var n = Ne(e.tagName), r = Ne(t.tagName);
                return e.namespaceURI === pe ? t.namespaceURI === he ? "svg" === n : t.namespaceURI === ue ? "svg" === n && ("annotation-xml" === r || ve[r]) : Boolean(be[n]) : e.namespaceURI === ue ? t.namespaceURI === he ? "math" === n : t.namespaceURI === pe ? "math" === n && ye[r] : Boolean(ke[n]) : e.namespaceURI === he && (t.namespaceURI !== pe || ye[r]) && (t.namespaceURI !== ue || ve[r]) && (r = qe({}, ["title", "style", "font", "a", "script"]), !ke[n] && (r[n] || !be[n]))
            }(e) || ("noscript" === n || "noembed" === n) && je(/<\/no(script|embed)/i, e.innerHTML) ? (we(e), 1) : (W && 3 === e.nodeType && (t = e.textContent, t = De(t, F, " "), t = De(t, C, " "), e.textContent !== t && (ze(c.removed, {element: e.cloneNode()}), e.textContent = t)), Te("afterSanitizeElements", e, null), 0);
            if (ne && !ie[n]) {
                var r = b(e) || e.parentNode, i = y(e) || e.childNodes;
                if (i && r) for (var o = i.length - 1; 0 <= o; --o) r.insertBefore(m(i[o], !0), v(e))
            }
            return we(e), 1
        }
        ...
        function Re(e, t, n) {
            ...
            if ((!Z || U[t] || !je(L, t)) && (!B || !je(z, t))) {
                if (!j[t] || U[t]) return !1;
                if (!le[t] && !je(D, De(n, M, "")) && ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== Pe(n, "data:") || !ae[e]) && (!G || je(N, De(n, M, ""))) && n) return !1
            }
            return !0
        }
        ...
        function Oe(e) {
            ...
            if (r) {
                for (var i = {attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: j}, n = r.length; n--;) {
                    var o = (l = r[n]).name, a = l.namespaceURI, t = Ie(l.value), s = Ne(o);
                    if (i.attrName = s, i.attrValue = t, i.keepAttr = !0, i.forceKeepAttr = void 0, Te("uponSanitizeAttribute", e, i), t = i.attrValue, !i.forceKeepAttr && (xe(o, e), i.keepAttr)) if (je(/\/>/i, t)) xe(o, e); else {
                        W && (t = De(t, F, " "), t = De(t, C, " "));
                        var l = e.nodeName.toLowerCase();
                        if (Re(l, s, t)) try {
                            a ? e.setAttributeNS(a, o, t) : e.setAttribute(o, t), Le(c.removed)
                        } catch (e) {
                        }
                    }
                }
        ...
        function $e(e) {
            var t, n = Se(e);
            for (Te("beforeSanitizeShadowDOM", e, null); t = n.nextNode();) Te("uponSanitizeShadowNode", t, null), Ee(t) || (t.content instanceof u && $e(t.content), Oe(t));
            Te("afterSanitizeShadowDOM", e, null)
        }

        return c.sanitize = function (e, t) {
            var n, r = void 0, i = void 0, o = void 0;
            if ((fe = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !Ae(e)) {
            ...
            if (!c.isSupported) {
                if ("object" === ct(s.toStaticHTML) || "function" == typeof s.toStaticHTML) {
                    if ("string" == typeof e) return s.toStaticHTML(e);
                    if (Ae(e)) return s.toStaticHTML(e.outerHTML)
                }
                return e
            }
            if (Y || O(t), c.removed = [], "string" == typeof e && (re = !1), !re) if (e instanceof p) 1 === (t = (r = _e("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === t.nodeName || "HTML" === t.nodeName ? r = t : r.appendChild(t); else {
                if (!K && !W && !V && -1 === e.indexOf("<")) return k && ee ? k.createHTML(e) : e;
                if (!(r = _e(e))) return K ? null : w
            }
            r && X && we(r.firstChild);
            for (var a = Se(re ? e : r); n = a.nextNode();) 3 === n.nodeType && n === i || Ee(n) || (n.content instanceof u && $e(n.content), Oe(n), i = n);
            if (i = null, re) return e;
            if (K) {
                if (Q) for (o = S.call(r.ownerDocument); r.firstChild;) o.appendChild(r.firstChild); else o = r;
                return J && (o = T.call(l, o, !0)), o
            }
            return e = V ? r.outerHTML : r.innerHTML, W && (e = De(e, F, " "), e = De(e, C, " ")), k && ee ? k.createHTML(e) : e
    ...
    function se(e) {
        ...
        ie || ((e = v("div")).classList.add("progress"), a(g, e), ie = e), t = i ? 80 < (t = parseInt(ie.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), ie.style.opacity = 1, ie.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(oe), oe = setTimeout(function (e) {
    ...
    function ce(i, e, t) {
        ...
        for (n in a.open("GET", i), t) l.call(t, n) && a.setRequestHeader(n, t[n]);
        return a.send(), {
            then: function (t, n) {
                var r;
                void 0 === n && (n = u), e && (r = setInterval(function (e) {
                    return se({step: Math.floor(5 * Math.random() + 1)})
                }, 500), o("progress", se), o("loadend", function (e) {
                    se(e), clearInterval(r)
                })), o("error", n), o("load", function (e) {
                    e = e.target;
                    400 <= e.status ? n(e) : (e = le[i] = {
                        content: e.response,
    ...
    function de(e, t, r, n) {
        ...
        return i.sort(function (e, t) {
            ...
            var t = decodeURI(e.getAttribute("href")), n = r ? e.parentNode : e;
            e.title = e.title || e.innerText, 0 !== a.indexOf(t) || o ? S(n, "remove", "active") : (o = e, S(n, "add", "active"))
        }), n && (f.title = o ? o.title || o.innerText + " - " + pe : pe), o
    }
    ...
    function me() {
        ...
        }(this, me), this.start = e.start, this.end = e.end, this.decimal = e.decimal
    }
    ...
    function be() {
        ...
        !function (e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }(this, be), this.duration = e.duration || 1e3, this.ease = e.easing || this._defaultEase, this.tweener = e.tweener || new ge(e), this.start = this.tweener.start, this.end = this.tweener.end, this.frame = null, this.next = null, this.isRunning = !1, this.events = {}, this.direction = this.start < this.end ? "up" : "down"
    }
    ...
    function we(e) {
        var t, n = y({
            ...
            r = ke || [].slice.call(document.getElementsByTagName("script")).filter(function (e) {
                return /docsify\./.test(e.src)
            })[0];
        if (r) for (var i in n) {
            !l.call(n, i) || c(t = r.getAttribute("data-" + o(i))) && (n[i] = "" === t || t)
        }
    ...
    var xe = {}, _e = !1, Se = null, Ae = !0, Te = 0;

    function Ee(e) {
        if (Ae) {
            for (var t, n, r = d(".sidebar"), i = k(".anchor"), o = b(r, ".sidebar-nav"), a = b(r, "li.active"), s = document.documentElement, l = (s && s.scrollTop || document.body.scrollTop) - Te, c = 0, u = i.length; c < u; c += 1) {
                var p = i[c];
                if (p.offsetTop > l) {
                    t = t || p;
                    break
            ...
            !t || (n = xe[Re(e, t.getAttribute("data-id"))]) && n !== a && (a && a.classList.remove("active"), n.classList.add("active"), a = n, !_e && g.classList.contains("sticky") && (s = r.clientHeight, e = a.offsetTop + a.clientHeight + 40, n = a.offsetTop >= o.scrollTop && e <= o.scrollTop + s, a = +e < s, r.scrollTop = n ? o.scrollTop : a ? 0 : e - s))
        }
    }
    ...
    function Oe(e, t) {
        var n, r;
        t && (r = we().topMargin, (n = b("#" + t)) && (n = n, void 0 === (r = r) && (r = 0), Se && Se.stop(), Ae = !1, Se = new ye({
            ...
            Ae = !0, Se = null
        }).begin()), e = xe[Re(e, t)], (t = b(d(".sidebar"), "li.active")) && t.classList.remove("active"), e && e.classList.add("active"))
    }
    ...
    var mt = ft(function (t) {
        ...
        }), vt = (mt.defaults, mt.getDefaults, mt.changeDefaults, /[&<>"']/), yt = /[&<>"']/g, bt = /[<>"']|&(?!#?\w+;)/,
        kt = /[<>"']|&(?!#?\w+;)/g, wt = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"};
    ...
    var St = /(^|[^\[])\^/g;
    var At = /[^\w:]/g, Tt = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;
    var Et = {}, Rt = /^[^:]+:\/*[^/]*$/, Ot = /^([^:]+:)[\s\S]*$/, $t = /^([^:]+:\/*[^/]*)[\s\S]*$/;

    function Ft(e, t) {
        Et[" " + e] || (Rt.test(e) ? Et[" " + e] = e + "/" : Et[" " + e] = Ct(e, "/", !0));
        var n = -1 === (e = Et[" " + e]).indexOf(":");
        return "//" === t.substring(0, 2) ? n ? t : e.replace(Ot, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace($t, "$1") + t : e + t
    }
    ...
    var Lt = function (e, t) {
        ...
        return e
    }, zt = _t, Nt = function (n, e) {
        n = n.source || n, e = e || "";
        var r = {
            replace: function (e, t) {
                return t = (t = t.source || t).replace(St, "$1"), n = n.replace(e, t), r
            }, getRegex: function () {
        ...
        return n + e
    }, jt = mt.defaults, Ht = Ct, qt = It, Ut = Lt, Bt = I;

    function Zt(e, t, n) {
        var r = t.href, i = t.title ? Ut(t.title) : null, t = e[1].replace(/\\([\[\]])/g, "$1");
    ...
    var Gt = function () {
        ...
        return e.prototype.space = function (e) {
            ...
            if (t) {
                var n = t[2].trim();
                return /#$/.test(n) && (e = Ht(n, "#"), !this.options.pedantic && e && !/ $/.test(e) || (n = e.trim())), {
                    type: "heading",
                    raw: t[0],
                    depth: t[1].length,
                    text: n
            ...
            if (e) {
                ...
                if (t.header.length === t.align.length) {
                    ...
                    for (n = t.cells.length, r = 0; r < n; r++) t.cells[r] = qt(t.cells[r], t.header.length);
                    return t
                }
            }
            ...
            if (e) {
                for (var t, n, r, i, o, a = e[0], s = e[2], l = 1 < s.length, c = {
                    type: "list",
                    raw: a,
                    ordered: l,
                    start: l ? +s.slice(0, -1) : "",
                    loose: !1,
                    items: []
                }, u = e[0].match(this.rules.block.item), p = !1, h = u.length, d = this.rules.block.listItemStart.exec(u[0]), f = 0; f < h; f++) {
                    if (a = t = u[f], f !== h - 1) {
                        if (r = this.rules.block.listItemStart.exec(u[f + 1]), this.options.pedantic ? r[1].length > d[1].length : r[1].length > d[0].length || 3 < r[1].length) {
                            u.splice(f, 2, u[f] + "\n" + u[f + 1]), f--, h--;
                            continue
                        }
                        (!this.options.pedantic || this.options.smartLists ? r[2][r[2].length - 1] !== s[s.length - 1] : l == (1 === r[2].length)) && (n = u.slice(f + 1).join("\n"), c.raw = c.raw.substring(0, c.raw.length - n.length), f = h - 1), d = r
                    }
                    r = t.length, ~(t = t.replace(/^ *([*+-]|\d+[.)]) ?/, "")).indexOf("\n ") && (r -= t.length, t = this.options.pedantic ? t.replace(/^ {1,4}/gm, "") : t.replace(new RegExp("^ {1," + r + "}", "gm"), "")), r = p || /\n\n(?!\s*$)/.test(t), f !== h - 1 && (p = "\n" === t.charAt(t.length - 1), r = r || p), r && (c.loose = !0), this.options.gfm && (o = void 0, (i = /^\[[ xX]\] /.test(t)) && (o = " " !== t[1], t = t.replace(/^\[[ xX]\] +/, ""))), c.items.push({
                        type: "list_item",
                        raw: a,
                        task: i,
                        checked: o,
            ...
            if (e) return {
                ...
                text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(e[0]) : Ut(e[0]) : e[0]
            }
            ...
            if (e) {
                ...
                if (t.header.length === t.align.length) {
                    t.raw = e[0];
                    for (var n = t.align.length, r = 0; r < n; r++) /^ *-+: *$/.test(t.align[r]) ? t.align[r] = "right" : /^ *:-+: *$/.test(t.align[r]) ? t.align[r] = "center" : /^ *:-+ *$/.test(t.align[r]) ? t.align[r] = "left" : t.align[r] = null;
                    for (n = t.cells.length, r = 0; r < n; r++) t.cells[r] = qt(t.cells[r].replace(/^ *\| *| *\| *$/g, ""), t.header.length);
                    return t
                }
            }
            ...
            if (t) {
                ...
                if (!this.options.pedantic && /^</.test(n)) {
                    ...
                    var r = Bt(t[2], "()");
                    -1 < r && (o = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r, t[2] = t[2].substring(0, r), t[0] = t[0].substring(0, o).trim(), t[3] = "")
                }
                var i, r = t[2], o = "";
                return this.options.pedantic ? (i = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r), i && (r = i[1], o = i[3])) : o = t[3] ? t[3].slice(1, -1) : "", r = r.trim(), /^</.test(r) && (r = this.options.pedantic && !/>$/.test(n) ? r.slice(1) : r.slice(1, -1)), Zt(t, {
            ...
            if (r && (!r[1] || r[1] && ("" === n || this.rules.inline.punctuation.exec(n)))) {
                ...
                for (o.lastIndex = 0; null != (r = o.exec(t));) if (i = this.rules.inline.strong.middle.exec(t.slice(0, r.index + 3))) return {
                    type: "strong",
            ...
            if (r && (!r[1] || r[1] && ("" === n || this.rules.inline.punctuation.exec(n)))) {
                ...
                for (o.lastIndex = 0; null != (r = o.exec(t));) if (i = this.rules.inline.em.middle.exec(t.slice(0, r.index + 2))) return {
                    type: "em",
                    raw: e.slice(0, i[0].length),
            ...
            if (t) {
                var n = t[2].replace(/\n/g, " "), r = /[^ ]/.test(n), e = /^ /.test(n) && / $/.test(n);
                return r && e && (n = n.substring(1, n.length - 1)), n = Ut(n, !0), {
                    type: "codespan",
                    raw: t[0],
                    text: n
                }
            ...
            if (e) {
                var n, t = "@" === e[2] ? "mailto:" + (n = Ut(this.options.mangle ? t(e[1]) : e[1])) : n = Ut(e[1]);
                return {type: "link", raw: e[0], text: n, href: t, tokens: [{type: "text", raw: n, text: n}]}
            }
        }, e.prototype.url = function (e, t) {
            var n, r, i, o;
            if (n = this.rules.inline.url.exec(e)) {
                if ("@" === n[2]) i = "mailto:" + (r = Ut(this.options.mangle ? t(n[0]) : n[0])); else {
            ...
            if (e) {
                n = t ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(e[0]) : Ut(e[0]) : e[0] : Ut(this.options.smartypants ? n(e[0]) : e[0]);
    ...
    It.punctuation = I(It.punctuation).replace(/punctuation/g, It._punctuation).getRegex(), It._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>", It._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*", It._comment = I(Nt._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(), It.em.start = I(It.em.start).replace(/punctuation/g, It._punctuation).getRegex(), It.em.middle = I(It.em.middle).replace(/punctuation/g, It._punctuation).replace(/overlapSkip/g, It._overlapSkip).getRegex(), It.em.endAst = I(It.em.endAst, "g").replace(/punctuation/g, It._punctuation).getRegex(), It.em.endUnd = I(It.em.endUnd, "g").replace(/punctuation/g, It._punctuation).getRegex(), It.strong.start = I(It.strong.start).replace(/punctuation/g, It._punctuation).getRegex(), It.strong.middle = I(It.strong.middle).replace(/punctuation/g, It._punctuation).replace(/overlapSkip/g, It._overlapSkip).getRegex(), It.strong.endAst = I(It.strong.endAst, "g").replace(/punctuation/g, It._punctuation).getRegex(), It.strong.endUnd = I(It.strong.endUnd, "g").replace(/punctuation/g, It._punctuation).getRegex(), It.blockSkip = I(It._blockSkip, "g").getRegex(), It.overlapSkip = I(It._overlapSkip, "g").getRegex(), It._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, It._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, It._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, It.autolink = I(It.autolink).replace("scheme", It._scheme).replace("email", It._email).getRegex(), It._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, It.tag = I(It.tag).replace("comment", It._comment).replace("attribute", It._attribute).getRegex(), It._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, It._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/, It._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, It.link = I(It.link).replace("label", It._label).replace("href", It._href).replace("title", It._title).getRegex(), It.reflink = I(It.reflink).replace("label", It._label).getRegex(), It.reflinkSearch = I(It.reflinkSearch, "g").replace("reflink", It.reflink).replace("nolink", It.nolink).getRegex(), It.normal = Dt({}, It), It.pedantic = Dt({}, It.normal, {
        ...
        link: I(/^!?\[(label)\]\((.*?)\)/).replace("label", It._label).getRegex(),
        reflink: I(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", It._label).getRegex()
    }), It.gfm = Dt({}, It.normal, {
    ...
    }), It.gfm.url = I(It.gfm.url, "i").replace("email", It.gfm._extended_email).getRegex(), It.breaks = Dt({}, It.gfm, {
        br: I(It.br).replace("{2,}", "*").getRegex(),
        text: I(It.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
    });
    var It = {block: Nt, inline: It}, Wt = mt.defaults, Vt = It.block, Yt = It.inline, Xt = Q;
    ...
    var Jt = function () {
        function n(e) {
            this.tokens = [], this.tokens.links = Object.create(null), this.options = e || Wt, this.options.tokenizer = this.options.tokenizer || new Gt, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options;
            e = {block: Vt.normal, inline: Yt.normal};
            this.options.pedantic ? (e.block = Vt.pedantic, e.inline = Yt.pedantic) : this.options.gfm && (e.block = Vt.gfm, this.options.breaks ? e.inline = Yt.breaks : e.inline = Yt.gfm), this.tokenizer.rules = e
        }
        ...
        return e.rules.get = function () {
            ...
            var r, i, o, a;
            for (void 0 === t && (t = []), void 0 === n && (n = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e;) if (r = this.tokenizer.space(e)) e = e.substring(r.raw.length), r.type && t.push(r); else if (r = this.tokenizer.code(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : ((a = t[t.length - 1]).raw += "\n" + r.raw, a.text += "\n" + r.text); else if (r = this.tokenizer.fences(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.heading(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.nptable(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.hr(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.blockquote(e)) e = e.substring(r.raw.length), r.tokens = this.blockTokens(r.text, [], n), t.push(r); else if (r = this.tokenizer.list(e)) {
            ...
            for (var t, n, r, i, o, a = e.length, s = 0; s < a; s++) switch ((o = e[s]).type) {
                ...
                case"table":
                    ...
                    for (r = o.cells.length, t = 0; t < r; t++) for (i = o.cells[t], o.tokens.cells[t] = [], n = 0; n < i.length; n++) o.tokens.cells[t][n] = [], this.inlineTokens(i[n], o.tokens.cells[t][n]);
                    break;
                case"blockquote":
            ...
            if (this.tokens.links) {
                ...
                if (0 < c.length) for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(l));) c.includes(o[0].slice(o[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, o.index) + "[" + Xt("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (; null != (o = this.tokenizer.rules.inline.blockSkip.exec(l));) l = l.slice(0, o.index) + "[" + Xt("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
            for (; e;) if (a || (s = ""), a = !1, i = this.tokenizer.escape(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.tag(e, n, r)) e = e.substring(i.raw.length), n = i.inLink, r = i.inRawBlock, t.push(i); else if (i = this.tokenizer.link(e)) e = e.substring(i.raw.length), "link" === i.type && (i.tokens = this.inlineTokens(i.text, [], !0, r)), t.push(i); else if (i = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(i.raw.length), "link" === i.type && (i.tokens = this.inlineTokens(i.text, [], !0, r)), t.push(i); else if (i = this.tokenizer.strong(e, l, s)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.em(e, l, s)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.codespan(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.br(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.del(e)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.autolink(e, Qt)) e = e.substring(i.raw.length), t.push(i); else if (n || !(i = this.tokenizer.url(e, Qt))) {
                if (i = this.tokenizer.inlineText(e, r, Kt)) e = e.substring(i.raw.length), s = i.raw.slice(-1), a = !0, t.push(i); else if (e) {
    ...
    }(), en = mt.defaults, tn = Mt, nn = Lt, rn = function () {
        function e(e) {
            this.options = e || en
        }
        ...
        return e.prototype.code = function (e, t, n) {
            ...
            if (null === (e = tn(this.options.sanitize, this.options.baseUrl, e))) return n;
            e = '<a href="' + nn(e) + '"';
    ...
    }(), sn = mt.defaults, ln = zt, cn = function () {
        function n(e) {
            this.options = e || sn, this.options.renderer = this.options.renderer || new rn, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new on, this.slugger = new an
        }
        ...
        return n.parse = function (e, t) {
            ...
            void 0 === t && (t = !0);
            for (var n, r, i, o, a, s, l, c, u, p, h, d, f, g, m, v = "", y = e.length, b = 0; b < y; b++) switch ((c = e[b]).type) {
                case"space":
                    continue;
                case"hr":
                    v += this.renderer.hr();
                    continue;
                case"heading":
                    v += this.renderer.heading(this.parseInline(c.tokens), c.depth, ln(this.parseInline(c.tokens, this.textRenderer)), this.slugger);
                    continue;
                case"code":
                ...
                case"table":
                    ...
                    for (u += this.renderer.tablerow(s), l = "", i = c.cells.length, n = 0; n < i; n++) {
                        for (s = "", o = (a = c.tokens.cells[n]).length, r = 0; r < o; r++) s += this.renderer.tablecell(this.parseInline(a[r]), {
                            header: !1,
                            align: c.align[r]
                        });
                ...
                case"blockquote":
                    ...
                    continue;
                case"list":
                    for (u = c.ordered, k = c.start, p = c.loose, i = c.items.length, l = "", n = 0; n < i; n++) f = (d = c.items[n]).checked, g = d.task, h = "", d.task && (m = this.renderer.checkbox(f), p ? 0 < d.tokens.length && "text" === d.tokens[0].type ? (d.tokens[0].text = m + " " + d.tokens[0].text, d.tokens[0].tokens && 0 < d.tokens[0].tokens.length && "text" === d.tokens[0].tokens[0].type && (d.tokens[0].tokens[0].text = m + " " + d.tokens[0].tokens[0].text)) : d.tokens.unshift({
                        type: "text",
                        text: m
                    }) : h += m), h += this.parse(d.tokens, p), l += this.renderer.listitem(h, g, f);
                ...
                case"paragraph":
                    ...
                    continue;
                case"text":
                    for (l = c.tokens ? this.parseInline(c.tokens) : c.text; b + 1 < y && "text" === e[b + 1].type;) l += "\n" + ((c = e[++b]).tokens ? this.parseInline(c.tokens) : c.text);
            ...
            t = t || this.renderer;
            for (var n = "", r = e.length, i = 0; i < r; i++) switch ((o = e[i]).type) {
                case"escape":
                    n += t.text(o.text);
                    break;
                case"html":
    ...
    }(), un = Pt, pn = ee, hn = Lt, Lt = mt.getDefaults, dn = mt.changeDefaults, mt = mt.defaults;

    function fn(e, n, r) {
        if (null == e) throw new Error("marked(): input parameter is undefined or null");
        if ("string" != typeof e) throw new Error("marked(): input parameter is of type " + Object.prototype.toString.call(e) + ", string expected");
        if ("function" == typeof n && (r = n, n = null), n = un({}, fn.defaults, n || {}), pn(n), r) {
            var i, o = n.highlight;
            try {
                i = Jt.lex(e, n)
            } catch (e) {
            ...
            var s = 0;
            return fn.walkTokens(i, function (n) {
    ...
    fn.options = fn.setOptions = function (e) {
        return un(fn.defaults, e), dn(fn.defaults), fn
    }, fn.getDefaults = Lt, fn.defaults = mt, fn.use = function (o) {
        var t, e = un({}, o);
        if (o.renderer) {
            var n, a = fn.defaults.renderer || new rn;
            for (n in o.renderer) !function (r) {
                var i = a[r];
                a[r] = function () {
                    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
        ...
        if (o.tokenizer) {
            var i, s = fn.defaults.tokenizer || new Gt;
            for (i in o.tokenizer) !function () {
                var r = s[i];
                s[i] = function () {
                    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
        ...
        o.walkTokens && (t = fn.defaults.walkTokens, e.walkTokens = function (e) {
        ...
        for (var n = 0, r = e; n < r.length; n += 1) {
            ...
            switch (t(i), i.type) {
                case"table":
                    ...
                    for (var l = 0, c = i.tokens.cells; l < c.length; l += 1) for (var u = 0, p = c[l]; u < p.length; u += 1) {
                        var h = p[u];
                        fn.walkTokens(h, t)
                    }
                    break;
        ...
        try {
            ...
            return t.walkTokens && fn.walkTokens(n, t.walkTokens), cn.parseInline(n, t)
        } catch (e) {
            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", t.silent) return "<p>An error occurred:</p><pre>" + hn(e.message + "", !0) + "</pre>";
            throw e
        }
    }, fn.Parser = cn, fn.parser = cn.parse, fn.Renderer = rn, fn.TextRenderer = on, fn.Lexer = Jt, fn.lexer = Jt.lex, fn.Tokenizer = Gt, fn.Slugger = an;
    var gn = fn.parse = fn;
    ...
    function mn(e, n) {
        ...
        return e.forEach(function (e) {
            ...
            r += '<li><a class="section-link" href="' + e.slug + '" title="' + t + '">' + e.title + "</a></li>", e.children && (r += mn(e.children, n))
        }), n.replace("{inner}", r)
    }
    ...
    function yn(e, r) {
        var i = [], o = {};
        return e.forEach(function (e) {
            var t = e.level || 1, n = t - 1;
            r < t || (o[n] ? o[n].children = (o[n].children || []).concat(e) : i.push(e), o[t] = e)
        }), i
    }
    ...
    function xn(e) {
        ...
        var t = e.trim().replace(/[A-Z]+/g, wn).replace(/<[^>]+>/g, "").replace(kn, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1"),
            e = bn[t], e = l.call(bn, t) ? e + 1 : 0;
    ...
    var Tn, En = ft(function (e) {
        var a, s, l, c, u, r, t, i = function (l) {
            var c = /\blang(?:uage)?-([\w-]+)\b/i, t = 0, $ = {
                    ...
                    encode: function e(t) {
                        ...
                        switch (r = r || {}, $.util.type(e)) {
                            case"Object":
                                ...
                                return i;
                            case"Array":
                                return (t = $.util.objId(e), r[t]) ? r[t] : (i = [], r[t] = i, e.forEach(function (e, t) {
                                    i[t] = n(e, r)
                                }), i);
                            default:
                                return e
                ...
                languages: {
                    extend: function (e, t) {
                        var n, r = $.util.clone($.languages[e]);
                        for (n in t) r[n] = t[n];
                        return r
                    }, insertBefore: function (n, e, t, r) {
                        var i, o = (r = r || $.languages)[n], a = {};
                        for (i in o) if (o.hasOwnProperty(i)) {
                            if (i == e) for (var s in t) t.hasOwnProperty(s) && (a[s] = t[s]);
                            t.hasOwnProperty(i) || (a[i] = o[i])
                        }
                        var l = r[n];
                        return r[n] = a, $.languages.DFS($.languages, function (e, t) {
                            t === l && e != n && (this[e] = a)
                        }), a
                    }, DFS: function e(t, n, r, i) {
                        i = i || {};
                        var o, a, s, l = $.util.objId;
                        for (o in t) {
                            t.hasOwnProperty(o) && (n.call(t, o, t[o], r || o), a = t[o], "Object" !== (s = $.util.type(a)) || i[l(a)] ? "Array" !== s || i[l(a)] || (i[l(a)] = !0, e(a, n, o, i)) : (i[l(a)] = !0, e(a, n, null, i)))
                        }
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function (e, t, n) {
                    ...
                    $.hooks.run("before-highlightall", r), r.elements = Array.prototype.slice.apply(r.container.querySelectorAll(r.selector)), $.hooks.run("before-all-elements-highlight", r);
                    for (var i, o = 0; i = r.elements[o++];) $.highlightElement(i, !0 === t, r.callback)
                },
                highlightElement: function (e, t, n) {
                    var r = $.util.getLanguage(e), i = $.languages[r];
                    e.className = e.className.replace(c, "").replace(/\s+/g, " ") + " language-" + r;
                    var o = e.parentElement;
                    o && "pre" === o.nodeName.toLowerCase() && (o.className = o.className.replace(c, "").replace(/\s+/g, " ") + " language-" + r);
                    var a = {element: e, language: r, grammar: i, code: e.textContent};

                    function s(e) {
                        a.highlightedCode = e, $.hooks.run("before-insert", a), a.element.innerHTML = a.highlightedCode, $.hooks.run("after-highlight", a), $.hooks.run("complete", a), n && n.call(a.element)
                    }

                    if ($.hooks.run("before-sanity-check", a), !a.code) return $.hooks.run("complete", a), void (n && n.call(a.element));
                    $.hooks.run("before-highlight", a), a.grammar ? t && l.Worker ? ((t = new Worker($.filename)).onmessage = function (e) {
                        s(e.data)
                    }, t.postMessage(JSON.stringify({
                        language: a.language,
                        code: a.code,
                        immediateClose: !0
                    }))) : s($.highlight(a.code, a.grammar, a.language)) : s($.util.encode(a.code))
                },
                highlight: function (e, t, n) {
                    n = {code: e, grammar: t, language: n};
                    return $.hooks.run("before-tokenize", n), n.tokens = $.tokenize(n.code, n.grammar), $.hooks.run("after-tokenize", n), F.stringify($.util.encode(n.tokens), n.language)
                },
                tokenize: function (e, t) {
                    ...
                    var i = new o;
                    return L(i, i.head, e), function e(t, n, r, i, o, a) {
                        for (var s in r) if (r.hasOwnProperty(s) && r[s]) {
                            var l = r[s];
                            l = Array.isArray(l) ? l : [l];
                            for (var c = 0; c < l.length; ++c) {
                                if (a && a.cause == s + "," + c) return;
                                var u, p = l[c], h = p.inside, d = !!p.lookbehind, f = !!p.greedy, g = p.alias;
                                f && !p.pattern.global && (u = p.pattern.toString().match(/[imsuy]*$/)[0], p.pattern = RegExp(p.pattern.source, u + "g"));
                                for (var m = p.pattern || p, v = i.next, y = o; v !== n.tail && !(a && y >= a.reach); y += v.value.length, v = v.next) {
                                    var b = v.value;
                                    ...
                                    if (!(b instanceof F)) {
                                        ...
                                        if (f) {
                                            ...
                                            var x = k.index, _ = k.index + k[0].length, S = y;
                                            for (S += v.value.length; S <= x;) v = v.next, S += v.value.length;
                                            if (S -= v.value.length, y = S, v.value instanceof F) continue;
                                        ...
                                        var x = k.index, T = k[0], E = b.slice(0, x), R = b.slice(x + T.length),
                                            O = y + b.length;
                                        a && O > a.reach && (a.reach = O);
                                        var b = v.prev;
                                        E && (b = L(n, b, E), y += E.length), z(n, b, w);
                                        var T = new F(s, h ? $.tokenize(T, h) : T, g, T);
                                        v = L(n, b, T), R && L(n, v, R), 1 < w && e(t, n, r, v.prev, y, {
                                            cause: s + "," + c,
                                            reach: O
                                        })
                                    }
            ...
            function L(e, t, n) {
                var r = t.next, n = {value: n, prev: t, next: r};
            ...
            if (l.Prism = $, F.stringify = function t(e, n) {
                ...
                e && (Array.isArray(e) ? Array.prototype.push.apply(i.classes, e) : i.classes.push(e)), $.hooks.run("wrap", i);
                var o, a = "";
                ...
                var t = JSON.parse(e.data), n = t.language, e = t.code, t = t.immediateClose;
                l.postMessage($.highlight(e, $.languages[n], n)), t && l.close()
            }, !1)), $;
            var e, n = $.util.currentScript();

            function r() {
                $.manual || $.highlightAll()
            }

            return n && ($.filename = n.src, n.hasAttribute("data-manual") && ($.manual = !0)), $.manual || ("loading" === (e = document.readyState) || "interactive" === e && n && n.defer ? document.addEventListener("DOMContentLoaded", r) : window.requestAnimationFrame ? window.requestAnimationFrame(r) : window.setTimeout(r, 16)), $
        ...
        e.exports && (e.exports = i), void 0 !== dt && (dt.Prism = i), i.languages.markup = {
            comment: /<!--[\s\S]*?-->/,
            prolog: /<\?[\s\S]+?\?>/,
            doctype: {
                pattern: /<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,
        ...
        }), i.languages.markup && i.languages.markup.tag.addInlined("script", "javascript"), i.languages.js = i.languages.javascript, "undefined" != typeof self && self.Prism && self.document && (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), a = window.Prism, s = {
            js: "javascript",
            py: "python",
            rb: "ruby",
            ps1: "powershell",
            ...
            h: "c",
            tex: "latex"
        }, u = "pre[data-src]:not([" + (l = "data-src-status") + '="loaded"]):not([' + l + '="' + (c = "loading") + '"])', r = /\blang(?:uage)?-([\w-]+)\b/i, a.hooks.add("before-highlightall", function (e) {
            e.selector += ", " + u
        }), a.hooks.add("before-sanity-check", function (e) {
            var t, n, r, i, o = e.element;
            o.matches(u) && (e.code = "", o.setAttribute(l, c), (t = o.appendChild(document.createElement("CODE"))).textContent = "Loading…", n = o.getAttribute("data-src"), "none" === (e = e.language) && (r = (/\.(\w+)$/.exec(n) || [, "none"])[1], e = s[r] || r), p(t, e), p(o, e), (r = a.plugins.autoloader) && r.loadLanguages(e), (i = new XMLHttpRequest).open("GET", n, !0), i.onreadystatechange = function () {
                4 == i.readyState && (i.status < 400 && i.responseText ? (o.setAttribute(l, "loaded"), t.textContent = i.responseText, a.highlightElement(t)) : (o.setAttribute(l, "failed"), 400 <= i.status ? t.textContent = "✖ Error " + i.status + " while fetching file: " + i.statusText : t.textContent = "✖ Error: File does not exist or is empty"))
            }, i.send(null))
        }), t = !(a.plugins.fileHighlight = {
            highlight: function (e) {
                for (var t, n = (e || document).querySelectorAll(u), r = 0; t = n[r++];) a.highlightElement(t)
            }
    ...
    Tn = Prism, Object.defineProperties(Tn.languages["markup-templating"] = {}, {
        buildPlaceholders: {
            value: function (r, i, e, o) {
                var a;
                r.language === i && (a = r.tokenStack = [], r.code = r.code.replace(e, function (e) {
                    if ("function" == typeof o && !o(e)) return e;
                    for (var t, n = a.length; -1 !== r.code.indexOf(t = Rn(i, n));) ++n;
                    return a[n] = e, t
            ...
            value: function (c, u) {
                var p, h;
                c.language === u && c.tokenStack && (c.grammar = Tn.languages[u], p = 0, h = Object.keys(c.tokenStack), function e(t) {
                    for (var n = 0; n < t.length && !(p >= h.length); n++) {
                        var r, i, o, a, s, l = t[n];
                        "string" == typeof l || l.content && "string" == typeof l.content ? (i = h[p], o = c.tokenStack[i], r = "string" == typeof l ? l : l.content, s = Rn(u, i), -1 < (a = r.indexOf(s)) && (++p, i = r.substring(0, a), o = new Tn.Token(u, Tn.tokenize(o, c.grammar), "language-" + u, o), a = r.substring(a + s.length), s = [], i && s.push.apply(s, e([i])), s.push(o), a && s.push.apply(s, e([a])), "string" == typeof l ? t.splice.apply(t, [n, 1].concat(s)) : l.content = s)) : l.content && e(l.content)
                    }
                    return t
                }(c.tokens))
            }
    ...
    function On(i, e) {
        ...
        var a = r(e = i.markdown || {}) ? e(gn, t) : (gn.setOptions(y(e, {renderer: y(t, e.renderer)})), gn);
        this._marked = a, this.compile = function (n) {
            var r = !0, e = s(function (e) {
                r = !1;
                var t = "";
                return n ? (t = c(n) ? a(n) : a.parser(n), t = i.noEmoji ? t : t.replace(/:\+1:/g, ":thumbsup:").replace(/:-1:/g, ":thumbsdown:").replace(/<(pre|template|code)[^>]*?>[\s\S]+?<\/(pre|template|code)>/g, function (e) {
                    return e.replace(/:/g, "__colon__")
                }).replace(/:(\w+?):/gi, window.emojify || _n).replace(/__colon__/g, ":"), xn.clear(), t) : n
            })(n), t = o.router.parse().file;
            return r ? o.toc = o.cacheTOC[t] : o.cacheTOC[t] = [].concat(o.toc), e
        }
    }
    ...
    On.prototype.compileEmbed = function (e, t) {
        var n, r, i = Sn(t), o = i.str, i = i.config;
        if (t = o, i.include) return O(e) || (e = N(this.contentBase, F(this.router.getCurrentPath()), e)), i.type && (r = Fn[i.type]) ? (n = r.call(this, e, t)).type = i.type : (r = "code", /\.(md|markdown)/.test(e) ? r = "markdown" : /\.mmd/.test(e) ? r = "mermaid" : /\.html?/.test(e) ? r = "iframe" : /\.(mp4|ogg)/.test(e) ? r = "video" : /\.mp3/.test(e) && (r = "audio"), (n = Fn[r].call(this, e, t)).type = r), n.fragment = i.fragment, n
        ...
        var a, s, l, c, u, p, e = new gn.Renderer, t = this.linkTarget, n = this.linkRel, o = this.router,
            r = this.contentBase, h = this, i = {};
        return i.heading = e.heading = function (e, t) {
            var n = Sn(e), r = n.str, i = n.config, e = {level: t, title: An(r)};
            /<!-- {docsify-ignore} -->/g.test(r) && (r = r.replace("\x3c!-- {docsify-ignore} --\x3e", ""), e.title = An(r), e.ignoreSubHeading = !0), /{docsify-ignore}/g.test(r) && (r = r.replace("{docsify-ignore}", ""), e.title = An(r), e.ignoreSubHeading = !0), /<!-- {docsify-ignore-all} -->/g.test(r) && (r = r.replace("\x3c!-- {docsify-ignore-all} --\x3e", ""), e.title = An(r), e.ignoreAllSubs = !0), /{docsify-ignore-all}/g.test(r) && (r = r.replace("{docsify-ignore-all}", ""), e.title = An(r), e.ignoreAllSubs = !0);
            n = xn(i.id || r), i = o.toURL(o.getCurrentPath(), {id: n});
            return e.slug = i, h.toc.push(e), "<h" + t + ' id="' + n + '"><a href="' + i + '" data-id="' + n + '" class="anchor"><span>' + r + "</span></a></h" + t + ">"
        }, i.code = {renderer: e}.renderer.code = function (e, t) {
            void 0 === t && (t = "markup");
            var n = En.languages[t] || En.languages.markup;
            return '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + En.highlight(e.replace(/@DOCSIFY_QM@/g, "`"), n, t) + "</code></pre>"
        }, i.link = (n = (t = {
            renderer: e,
            router: o,
            linkTarget: t,
            linkRel: n,
            compilerClass: h
        }).renderer, a = t.router, s = t.linkTarget, l = t.linkRel, c = t.compilerClass, n.link = function (e, t, n) {
            void 0 === t && (t = "");
            var r = [], i = Sn(t), o = i.str, i = i.config;
        ...
        }), i.paragraph = {renderer: e}.renderer.paragraph = function (e) {
            e = /^!&gt;/.test(e) ? vn("tip", e) : /^\?&gt;/.test(e) ? vn("warn", e) : "<p>" + e + "</p>";
            return e
        }, i.image = (r = (n = {
            renderer: e,
            contentBase: r,
            ...
            var r = e, i = [], o = Sn(t), a = o.str, o = o.config;
            return t = a, o["no-zoom"] && i.push("data-no-zoom"), t && i.push('title="' + t + '"'), o.size && (t = (a = o.size.split("x"))[0], (a = a[1]) ? i.push('width="' + t + '" height="' + a + '"') : i.push('width="' + t + '"')), o.class && i.push('class="' + o.class + '"'), o.id && i.push('id="' + o.id + '"'), O(e) || (r = N(u, F(p.getCurrentPath()), e)), 0 < i.length ? '<img src="' + r + '" data-origin="' + e + '" alt="' + n + '" ' + i.join(" ") + " />" : '<img src="' + r + '" data-origin="' + e + '" alt="' + n + '"' + i + ">"
        }), i.list = {renderer: e}.renderer.list = function (e, t, n) {
            t = t ? "ol" : "ul";
            return "<" + t + " " + [/<li class="task-list-item">/.test(e.split('class="task-list"')[0]) ? 'class="task-list"' : "", n && 1 < n ? 'start="' + n + '"' : ""].join(" ").trim() + ">" + e + "</" + t + ">"
        }, i.listitem = {renderer: e}.renderer.listitem = function (e) {
            return /^(<input.*type="checkbox"[^>]*>)/.test(e) ? '<li class="task-list-item"><label>' + e + "</label></li>" : "<li>" + e + "</li>"
        }, e.origin = i, e
    }, On.prototype.sidebar = function (e, t) {
        var n = this.toc, r = this.router.getCurrentPath(), i = "";
        if (e) i = this.compile(e); else {
            for (var o = 0; o < n.length; o++) if (n[o].ignoreSubHeading) {
                var a = n[o].level;
                n.splice(o, 1);
                for (var s = o; s < n.length && a < n[s].level; s++) n.splice(s, 1) && s-- && o++;
                o--
            }
        ...
        var t = this.toc.slice(), e = this.compile(e);
        return this.toc = t.slice(), e
    };
    var Cn, Ln = function (e) {
        var t = function (e) {
            e = e.match(/^[ \t]*(?=\S)/gm);
    ...
    function Nn(e, r) {
        var o = e.compiler, i = e.raw;
        void 0 === i && (i = "");
        var t = e.fetch, e = zn[i];
        if (e) {
            var n = e.slice();
            return n.links = e.links, r(n)
        }
        var n = o._marked, a = n.lexer(i), s = [], l = n.Lexer.rules.inline.link, c = a.links;
        ...
        var u = [];
        !function (e, o) {
            var t, n = e.embedTokens, a = e.compile, s = (e.fetch, 0), l = 1;
            ...
            for (; t = n[s++];) {
                var r = function (i) {
                    return function (e) {
                        ...
                        }), !0 === (($docsify.frontMatter || {}).installed || !1) && (e = $docsify.frontMatter.parseMarkdown(e)), t = a.lexer(e)) : "code" === i.embed.type ? (i.embed.fragment && (r = i.embed.fragment, r = new RegExp("(?:###|\\/\\/\\/)\\s*\\[" + r + "\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[" + r + "\\]"), e = Ln((e.match(r) || [])[1] || "").trim()), t = a.lexer("```" + i.embed.lang + "\n" + e.replace(/`/g, "@DOCSIFY_QM@") + "\n```\n")) : "mermaid" === i.embed.type ? (t = [{
                            type: "html",
                            text: '<div class="mermaid">\n' + e + "\n</div>"
                        }]).links = {} : (t = [{type: "html", text: e}]).links = {}), o({
                            token: i,
                            embedToken: t
                        }), ++l >= s && o({})
                    }
            ...
            }), y(c, n.links), a = a.slice(0, t).concat(n, a.slice(t + 1)), u.push({
                start: t,
                length: n.length - 1
    ...
    function Mn(e, t, n) {
        var r, i, o, a;
        return t = "function" == typeof n ? n(t) : "string" == typeof n ? (o = [], a = 0, (r = n).replace(B, function (t, e, n) {
            o.push(r.substring(a, n - 1)), a = n += t.length + 1, o.push(i && i[t] || function (e) {
                return ("00" + ("string" == typeof Z[t] ? e[Z[t]]() : Z[t](e))).slice(-t.length)
            })
        }), a !== r.length && o.push(r.substring(a)), function (e) {
            for (var t = "", n = 0, r = e || new Date; n < o.length; n++) t += "string" == typeof o[n] ? o[n] : o[n](r);
            return t
    ...
    function Dn(e) {
        function t(e) {
            var t = Boolean(e.__vue__ && e.__vue__._isVue), e = Boolean(e._vnode && e._vnode.__v_skip);
            return t || e
        }

        var n = this.config, r = b(".markdown-section"),
            i = "Vue" in window && window.Vue.version && Number(window.Vue.version.charAt(0));
        if (e = e || "<h1>404 - Not found</h1>", "Vue" in window) for (var o = 0, a = k(".markdown-section > *").filter(t); o < a.length; o += 1) {
            var s = a[o];
        ...
        if (this._renderTo(r, e), n.loadSidebar || this._renderSidebar(), (n.executeScript || "Vue" in window && !1 !== n.executeScript) && (!(e = k(".markdown-section>script").filter(function (e) {
            ...
            2 === i && p.length && p.forEach(function (e) {
            ...
            }), !Cn && n.vueGlobalOptions && "function" == typeof n.vueGlobalOptions.data && (Cn = n.vueGlobalOptions.data()), u.push.apply(u, Object.keys(n.vueMounts || {}).map(function (e) {
                ...
                return Cn && (t.data = function () {
                    return Cn
                }), [e, t]
            })));
            for (var h = 0, d = u; h < d.length; h += 1) {
                var f, g = d[h], m = g[0], v = g[1], g = "data-isvue";
    ...
    function Pn(t, n, r, i, o, e) {
        t = e ? t : t.replace(/\/$/, ""), (t = F(t)) && ce(o.router.getFile(t + r) + n, !1, o.config.requestHeaders).then(i, function (e) {
            return Pn(t, n, r, i, o)
        })
    }
    ...
    var jn, Hn, qn = function (e) {
        function t() {
            e.call(this), this.config = we(this), this.initLifecycle(), this.initPlugin(), this.callHook("init"), this.initRouter(), this.initRender(), this.initEvent(), this.initFetch(), this.callHook("mounted")
        }

        return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.initPlugin = function () {
            var t = this;
            [].concat(this.config.plugins).forEach(function (e) {
                return r(e) && e(t._lifecycle, t)
            })
        }, t
    }((Hn = Object, function (e) {
        function t() {
            e.apply(this, arguments)
        }

        return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype._loadSideAndNav = function (e, t, n, r) {
            var i = this;
            return function () {
                if (!n) return r();
                Pn(e, t, n, function (e) {
            ...
            var r = this;
            void 0 === n && (n = u);
            var i, e, t, o, a, s = this.route.query, l = this.route.path;
            p(l) ? (history.replaceState(null, "", "#"), this.router.normalize()) : (i = R(s, ["id"]), t = (e = this.config).loadNavbar, s = e.requestHeaders, o = e.loadSidebar, a = this.router.getFile(l), s = Un(a + i, 0, s), this.isRemoteUrl = p(a), this.isHTML = /\.html$/g.test(a), s.then(function (e, t) {
                return r._renderMain(e, t, r._loadSideAndNav(l, i, o, n))
            }, function (e) {
                r._fetchFallbackPage(l, i, n) || r._fetch404(a, i, n)
            }), t && Pn(l, i, t, function (e) {
                return r._renderNav(e)
            }, this, !0))
        }, t.prototype._fetchCover = function () {
            var t = this, e = this.config, n = e.coverpage, r = e.requestHeaders, i = this.route.query,
                o = F(this.route.path);
            if (n) {
                var a = null, e = this.route.path;
                "string" == typeof n ? "/" === e && (a = n) : a = Array.isArray(n) ? -1 < n.indexOf(e) && "_coverpage" : !0 === (e = n[e]) ? "_coverpage" : e;
                var s = Boolean(a) && this.config.onlyCover;
                return a ? (a = this.router.getFile(o + a), this.coverIsHTML = /\.html$/g.test(a), ce(a + R(i, ["id"]), !1, r).then(function (e) {
            ...
            var o = this;
            void 0 === i && (i = u);
            var e = this.config, t = e.requestHeaders, a = e.fallbackLanguages, s = e.loadSidebar;
            if (!a) return !1;
            e = n.split("/")[1];
            if (-1 === a.indexOf(e)) return !1;
            e = this.router.getFile(n.replace(new RegExp("^/" + e), ""));
            return Un(e + r, 0, t).then(function (e, t) {
            ...
            var r = this;
            void 0 === n && (n = u);
            var i = this.config, o = i.loadSidebar, a = i.requestHeaders, i = i.notFoundPage,
            ...
            if (i) {
                ...
                return Un(this.router.getFile(e), 0, a).then(function (e, t) {
            ...
            var e, t = this, n = this.config.loadSidebar;
            this.rendered ? (e = de(this.router, ".sidebar-nav", !0, !0), n && e && (e.parentNode.innerHTML += window.__SUB_SIDEBAR__), this._bindEventOnRendered(e), this.$resetEvents(), this.callHook("doneEach"), this.callHook("ready")) : this.$fetch(function (e) {
        ...
        return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.$resetEvents = function (e) {
            var t = this, n = this.config.auto2top;
            "history" !== e && (t.route.query.id && Oe(t.route.path, t.route.query.id), "navigate" === e && n && (void 0 === (n = n) && (n = 0), $e.scrollTop = !0 === n ? 0 : Number(n))), this.config.loadNavbar && de(this.router, "nav")
            ...
            var e;
            e = "button.sidebar-toggle", this.router, null != (e = d(e)) && (x(e, "click", function (e) {
                e.stopPropagation(), t()
            }), h && x(g, "click", function (e) {
        ...
        return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype._renderTo = function (e, t, n) {
            e = d(e);
            ...
            !function (e) {
                ...
                for (var r, i = 0, o = n.length; i < o; i += 1) {
                    var a, s, l = n[i], c = l.querySelector("a");
                    c && ("/" !== (a = c.getAttribute("href")) && (c = (s = e.parse(a)).query.id, s = s.path, c && (a = Re(s, c))), a && (xe[decodeURIComponent(a)] = l))
                }
                h || (r = $(e.getCurrentPath()), _("scroll", function () {
                    return Ee(r)
                }), x("scroll", function () {
                    return Ee(r)
        ...
        return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.updateRender = function () {
            this.router.normalize(), this.route = this.router.parse(), g.setAttribute("data-page", this.route.file)
        }, e.prototype.initRouter = function () {
            var t = this, e = this.config, e = new ("history" === (e.routerMode || "hash") && i ? q : H)(e);
            this.router = e, this.updateRender(), U = this.route, e.onchange(function (e) {
                t.updateRender(), t._updateRender(), U.path !== t.route.path ? (t.$fetch(u, t.$resetEvents.bind(t, e.source)), U = t.route) : t.$resetEvents(e.source)
            })
        }, e
    }(function (e) {
        function t() {
        ...
        return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.initLifecycle = function () {
            var n = this;
            ...
            void 0 === r && (r = u);
            var i = this._hooks[e], o = function (t) {
                var e = i[t];
                t >= i.length ? r(n) : "function" == typeof e ? 2 === e.length ? e(n, function (e) {
                    n = e, o(t + 1)
                }) : (e = e(n), n = void 0 === e ? n : e, o(t + 1)) : o(t + 1)
            };
            o(0)
        }, t
    }(Hn)))))));
    ...
    window.Docsify = {
        ...
        slugify: xn,
        version: "4.12.2"
    }, window.DocsifyCompiler = On, window.marked = gn, window.Prism = En, e(function (e) {
        return new qn
    })
}();
